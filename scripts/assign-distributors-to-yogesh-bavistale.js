/**
 * Assign a list of distributors to employee "Yogesh Bavistale".
 * Run: node scripts/assign-distributors-to-yogesh-bavistale.js
...
const EMPLOYEE_NAME = 'Yogesh Bavistale'
