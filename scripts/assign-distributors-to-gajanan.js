/**
 * Assign a list of distributors to employee "Gajanan".
 * Run: node scripts/assign-distributors-to-gajanan.js
...
const DISTRIBUTOR_NAMES = [
  ...
  'Saumya Traders',
  'Yogesh Traders',
  'Sancheti Distributor',
  'Shubham Confectionary',
  'Hindustan Kirana',
  'Shri Krupa Sales',
]
