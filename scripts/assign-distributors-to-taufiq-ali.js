/**
 * Assign a list of distributors to employee "Taufiq Ali".
 * Run: node scripts/assign-distributors-to-taufiq-ali.js
...
const EMPLOYEE_NAME = 'Taufiq Ali'
const DISTRIBUTOR_NAMES = [
  'Tushar Agency (Warora)',
  'Atul Agency (Pandhrkawda)',
  'Adarsh conf. and Kirana Store',
  'Waheguru Bhandar (Wani)',
  'Wankhede Agency Bhadrawati',
  'Gausiya Marketing',
  'Giriraj Sales',
  'Prakash Agency',
  'Mahakali Traders',
